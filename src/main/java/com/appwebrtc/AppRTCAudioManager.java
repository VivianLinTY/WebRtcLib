...
public class AppRTCAudioManager {
    ...
    private class WiredHeadsetReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            LogUtils.d(TAG, "WiredHeadsetReceiver.onReceive" + AppRTCUtils.getThreadInfo() + ": "
    ...
    private AppRTCAudioManager(Context context) {
        ...
        LogUtils.d(TAG, "useSpeakerphone: " + useSpeakerphone);
        ...
        LogUtils.d(TAG, "defaultAudioDevice: " + defaultAudioDevice);
    ...
    public void start(AudioManagerEvents audioManagerEvents) {
        ...
        LogUtils.d(TAG, "AppRTCAudioManager starts...");
        ...
        audioFocusChangeListener = new AudioManager.OnAudioFocusChangeListener() {
            ...
            public void onAudioFocusChange(int focusChange) {
                ...
                LogUtils.d(TAG, "onAudioFocusChange: " + typeOfChange);
            }
        };
        ...
        if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
            LogUtils.d(TAG, "Audio focus request granted for VOICE_CALL streams");
        } else {
            LogUtils.e(TAG, "Audio focus request failed");
        }
        ...
        LogUtils.d(TAG, "AppRTCAudioManager started");
    }
    ...
    public void stop() {
        ...
        LogUtils.d(TAG, "Abandoned audio focus for VOICE_CALL streams");
        if (proximitySensor != null) {
            proximitySensor.stop();
            proximitySensor = null;
        }
        audioManagerEvents = null;
        LogUtils.d(TAG, "AppRTCAudioManager stopped");
    }

    /** Changes selection of the currently active audio device. */
    private void setAudioDeviceInternal(AudioDevice device) {
        LogUtils.d(TAG, "setAudioDeviceInternal(device=" + device + ")");
        ...
        switch (device) {
            ...
            case BLUETOOTH:
                ...
                break;
            default:
                LogUtils.e(TAG, "Invalid audio device selection");
                break;
        }
    ...
    public void setDefaultAudioDevice(AudioDevice defaultDevice) {
        ...
        switch (defaultDevice) {
            ...
            case EARPIECE:
                ...
                break;
            default:
                LogUtils.e(TAG, "Invalid default audio device selection");
                break;
        }
        LogUtils.d(TAG, "setDefaultAudioDevice(device=" + defaultAudioDevice + ")");
        updateAudioDeviceState();
    }
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            for (AudioDeviceInfo device : devices) {
                ...
                if (type == AudioDeviceInfo.TYPE_WIRED_HEADSET) {
                    LogUtils.d(TAG, "HasWiredHeadset: found wired headset");
                    return true;
                } else if (type == AudioDeviceInfo.TYPE_USB_DEVICE) {
                    LogUtils.d(TAG, "HasWiredHeadset: found USB audio device");
                    return true;
                }
            }
            return false;
    ...
    public void updateAudioDeviceState() {
        ...
        if (bluetoothManager.getState() == AppRTCBluetoothManager.State.HEADSET_AVAILABLE
                || bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTING
                || bluetoothManager.getState() == AppRTCBluetoothManager.State.SCO_CONNECTED) {
            LogUtils.d(TAG, "Need BT audio: start=" + needBluetoothAudioStart + ", "
        ...
        if (newAudioDevice != selectedAudioDevice || audioDeviceSetUpdated) {
            ...
            LogUtils.d(TAG, "New device status: "
                    + "available=" + audioDevices + ", "
        ...
        LogUtils.d(TAG, "--- updateAudioDeviceState done");
    }
}
